...
namespace FacultadesCRUD.Controllers
{
    public class FacultadsController : Controller
    {
        private readonly FacultadContext _context;

        public FacultadsController(FacultadContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombres,Direccion,Telefono,Email")] Facultad facultad)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombres,Direccion,Telefono,Email")] Facultad facultad)
        {
            if (id != facultad.Id)
            {
                return NotFound();
